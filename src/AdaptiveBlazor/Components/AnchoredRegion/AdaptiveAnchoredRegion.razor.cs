...
/// For more information <see href="https://github.com/microsoft/fast/packages/web-components/fast-foundation/src/anchored-region/anchored-region.spec.md">Microsoft FAST Docs</see>
/// </summary>
public partial class AdaptiveAnchoredRegion
{
    ...
    /// See <see cref="AxisPositioningMode"/>
    /// </summary>
    [Parameter] public AxisPositioningMode? HorizontalPositioningMode { get; set; } = AxisPositioningMode.Dynamic;

    /// <summary>
    /// The default horizontal position of the region relative to the anchor element
    /// Default is unset. See <see cref="HorizontalPosition"/>
    /// </summary>
    ...
    /// </summary>
    [Parameter] public bool HorizontalViewportLock { get; set; }
    ...
    /// See <see cref="AxisScalingMode"/>
    /// </summary>
    [Parameter] public AxisScalingMode? HorizontalScaling { get; set; } = AxisScalingMode.Content;
    ...
    /// See <see cref="AxisPositioningMode"/>
    /// </summary>
    [Parameter] public AxisPositioningMode? VerticalPositioningMode { get; set; } = AxisPositioningMode.Dynamic;

    /// <summary>
    /// The default vertical position of the region relative to the anchor element
    /// Default is "Unset". See <see cref="VerticalPosition"/>
    /// </summary>
    ...
    /// </summary>
    [Parameter] public bool VerticalViewportLock { get; set; }
    ...
    /// Default is "Content". See <see cref="AxisScalingMode"/>
    /// </summary>
    [Parameter] public AxisScalingMode? VerticalScaling { get; set; } = AxisScalingMode.Content;
    ...
    /// </summary>
    [Parameter] public bool FixedPlacement { get; set; }
    ...
    /// In 'auto' mode the component also updates because of - any scroll event on the document, window resizes and viewport resizes. See <see cref="AutoUpdateMode"/>
    /// </summary>
    [Parameter]
    public AutoUpdateMode? AutoUpdateMode { get; set; } = Components.AutoUpdateMode.Anchor;
}